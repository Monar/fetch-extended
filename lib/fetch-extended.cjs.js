...
function timeoutPromise(timeout, promise, url) {
  return new Promise(function (resolve, reject) {
    var timeoutId = setTimeout(function () {
      reject(new TimeoutError("Request ".concat(url, " reached timeout."), url, timeout));
    }, timeout);
...
function getFetchx(defaultHeaders, defautlOptions) {
  var defaults = {
